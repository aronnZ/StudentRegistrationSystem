						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <form action="sqlfix.php"  method="post">
                                    <div>
                                        <p>学号：<input type="text" id="studentID" name="stdID" placeholder="例如：S2117XXXX"></p>
                                    </div>
                                    <br/>
				...
				$( "#id-btn-dialog2" ).on('click', function(e) {
                    ...
                    xhr.onload = function(){
                        ...
                        if(result === '0'){
                            ...
                            //             click: function() {
                            //                 window.location.href="jquery-ui.php";//此处写苏皓楠的修改和删除php
                            //             }
                            //         }
                            //     ]
                            // });
                            let url = "stuchange1.php?index=" + stuId;
