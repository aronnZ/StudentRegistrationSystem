											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												foreach ($rows as $row)
												{
													...
													<tr>
																										...
																										<td name='$name3' >$count</td>
																										

																										<td>
																											<div class='visible-md visible-lg hidden-sm hidden-xs action-buttons'>
																												<a class='blue' href='#'>
																													<i class='icon-trash bigger-130' id = '$num' onclick ='deletethis()'></i>
																												</a>
...
<![endif]-->
		...
		<script>
			function deletethis()
			{
				...
				var r = window.confirm("您确定要删除这门课程吗");
				
				if(r==true)
				{
					var xhr = new XMLHttpRequest();

					xhr.open('post','prodelclass.php');
					...
					xhr.onload = function()
					{
						...
						{
							alert("删除成功！");
							location.href("proclasschoosed.php");
						}
						else
						{
							alert(result);
