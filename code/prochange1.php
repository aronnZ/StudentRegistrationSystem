							...
							<div class="col-xs-12">
                                    ...
                                    <section class="wrapper">
                                        <div class="table-agile-info">
                                            <div class="panel panel-default">
                                                ...
                                                <div>
                                                    <form action="prochange.php" method="post">
                                                        <table>
                                                            <?php
                                                            ...
                                                            <form role="form" method="post">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span style="color:red">*</span><input type="text" class="form-control" id="exampleInputEmail1" name="_id" required="required" value ="<?php echo $prof_id; ?>"readonly="true" disabled>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group" value ="<?php echo $status; ?>">
                                                                    <label >身份</label>&emsp;&emsp;&emsp;&emsp;
                                                                    <span>
                                                                            <input type="radio"  name="status" value="" readonly="true" disabled style="display:none" />
                                                                            <input type="radio" name="_status"  value="lecturer" <?php if($status=="lecturer")  echo "checked"?>/>讲师&emsp;
                                                                            <input type="radio" name="_status"  value="associate_prof" <?php if($status=="associate_prof")  echo "checked"?> />副教授&emsp;
                                                                            <input type="radio" name="_status"  value="prof" <?php if($status=="prof")  echo "checked"?> />教授
                                                                    </span>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="_extrainfo" >
                                                                        ...
                                                                        <option value="History" <?php if($dept_name=="History")  echo "selected";?>>考古学院</option>
                                                                        <option value="Art" <?php if($dept_name=="Art")  echo "selected";?>>美术学院 </option>
                                                                        <option value="Comp. Sci." <?php if($dept_name=="Comp. Sci.")  echo "selected";?>> 计算机科学与技术学院</option>
                                                                        <option value="Sociology"  <?php if($dept_name=="Sociology")  echo "selected";?>>社会学</option>
                                                                        <option value="Biology" <?php if($dept_name=="Biology")  echo "selected";?>>生物学院</option>
                                                                        <option value="Inorganic Chemistry" <?php if($dept_name=="Inorganic Chemistry")  echo "selected";?>>无机化学 </option>
                                                                        <option value="ForeLans" <?php if($dept_name=="ForeLans")  echo "selected";?>>外国语学院</option>
                                                                        <option value="Physics" <?php if($dept_name=="Physics")  echo "selected";?>>物理学院</option>
                                                                    </select>
                                                                </div>
                                                                <button type="button" class="btn btn-info" onclick ="login()">更改教授信息</button>&emsp;&emsp;
                                                                <button type="reset" class="btn btn-info">重置</button>&emsp;&emsp;
                                                                <input class="btn btn-info" type="button" value="返回上一页" onclick="window.location.href='prochange.php'"">
                                                            </form>
                                                        </table>
                                                    </form>
                                                </div>
                                ...
                                <script>
                                    function login() {
                                        ...
                                        xhr.send('id=' + id + '&M=P' +'&name=' + name + '&birthday=' + birthday + '&SSN=' + SSN + '&status=' + status + '&extrainfo=' + extrainfo +'&del=');
                                    }
                                </script>
